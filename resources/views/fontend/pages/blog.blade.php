        ...
        <div class="row">
            ...
            <div class="blog-card">
                ...
                <div class="content-holder">
                    ...
                    <p class="post-details">
                        <a href="#">By: {{ $blog->author->name ?? 'Admin' }}</a>
                        <a href="#"><i class="ti-heart text-danger"></i> 234</a> <!-- Example likes count -->
                        <a href="#"><i class="ti-comment"></i> 123</a> <!-- Example comments count -->
                    </p>
