<div class="container-fluid">
    <div id="about" class="row about-section">
        <div class="col-lg-4 about-card">
            ...
            <h5 class="mb-3">{{ $heroArea->heading ?? 'Default heading' }}</h5>
            <p class="mt-20">{{ $heroArea->subheading ?? 'Default Subheading' }}</p>
            ...
            @endif
            @if ($heroArea->file)
            <a href="{{ asset('storage/files/' . $heroArea->file) }}" class="btn btn-outline-primary mt-3">Download My CV</a>
            @endif
        </div>
