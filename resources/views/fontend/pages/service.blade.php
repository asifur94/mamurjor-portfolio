    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card mb-5">
                   <div class="card-header has-icon">
                        <i class="{{ $service->icon }} text-danger" aria-hidden="true"></i> <!-- Dynamically display icon -->
                    </div>
                    <div class="card-body px-4 py-3">
                        <h5 class="mb-3 card-title text-dark">{{ $service->title }}</h5> <!-- Dynamically display title -->
                        <p class="subtitle">{{ Str::limit($service->description, 150) }}</p> <!-- Dynamically display description -->
                    </div>
                </div>
            </div>
            @endforeach
